...
import { SheetLarge } from "@/components/ui/SheetLarge/SheetLarge";
import { SheetMedium } from "@/components/ui/SheetMedium/SheetMedium";
...
export default function Page() {
  ...
  const [multiSelectDemoSize, setMultiSelectDemoSize] =
    useState<ComponentSize>("md");
  ...
  const [toasts, setToasts] = useState<
    { id: number; message: string; variant?: "success" | "error" | "info" }[]
  >([]);
  ...
  const [activeBottomNav, setActiveBottomNav] =
    useState<(typeof bottomNavItems)[number]["key"]>("ACCOUNT");

  const standardTabs = ["ALL", "NEW", "SALE"] as const;
  const [activeStandardTab, setActiveStandardTab] =
    useState<(typeof standardTabs)[number]>("ALL");
  ...
  const [activeSegment, setActiveSegment] =
    useState<(typeof segmentOptions)[number]>("TOPS");
  ...
  const singleSelectOptions = categoryOptions.map((option) => ({
    value: option,
    label: option,
  }));
  const multiSelectOptions = ["S", "M", "L", "FREE"].map((option) => ({
    value: option,
    label: option,
  }));
  const orderRows = [
        ...
        <div className="space-y-24">
          ...
          <section>
            ...
            <div
              ...
              style={{
                gap: "calc(var(--ui-font-size, var(--lk-size-md)) / var(--sqrt-phi, 1.272))",
              }}
            >
              <Checkbox
            ...
            <div className="mb-5 flex flex-wrap gap-3">
              {(["xs", "sm", "md", "lg", "xl"] as const).map((size) => (
                <Button
                  ...
                  size="xs"
                  variant={
                    multiSelectDemoSize === size ? "primary" : "secondary"
                  }
          ...
          <section>
            ...
            <div className="max-w-md mx-auto">
              <BottomNavigation
                ...
                onChange={(key) =>
                  setActiveBottomNav(
                    key as (typeof bottomNavItems)[number]["key"],
                  )
                }
                fixed={false}
                appearance="minimal"
            ...
            <div className="space-y-12">
              <div>
                ...
                <TabSegmentControl
                  ...
                  onChange={(key) =>
                    setActiveStandardTab(key as (typeof standardTabs)[number])
                  }
                  size={demoSize}
                />
              </div>
              <div>
                ...
                <TabSegmentControl
                  ...
                  onChange={(key) =>
                    setActiveSegment(key as (typeof segmentOptions)[number])
                  }
                  size={demoSize}
                />
              </div>
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  setToasts((prev) => [
                    ...prev,
                    { id, message: "エラーが発生しました", variant: "error" },
                  ]);
                  setTimeout(() => {
                    setToasts((prev) => prev.filter((t) => t.id !== id));
                  }, 3000);
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  setToasts((prev) => [
                    ...prev,
                    { id, message: "情報を確認してください", variant: "info" },
                  ]);
                  setTimeout(() => {
                    setToasts((prev) => prev.filter((t) => t.id !== id));
                  }, 3000);
          ...
          <section>
            ...
            <Accordion
              ...
              onOpenChange={(key) =>
                setOpenAccordion(key as "shipping" | "returns" | "size" | null)
              }
              size={demoSize}
            />
          </section>
          ...
          <section>
            ...
            <div className="space-y-6">
              <Toolbar
                leftItems={toolbarPrimaryLeftItems}
                rightItems={toolbarPrimaryRightItems}
                splitIndex={3}
                size={demoSize}
              />
              <Toolbar
                variant="muted"
                leftItems={toolbarSecondaryLeftItems}
                rightItems={toolbarSecondaryRightItems}
                size={demoSize}
              />
            </div>
          </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  <TagLabel variant="solid" size={demoSize}>
                    NEW
                  </TagLabel>
                  <TagLabel variant="outline" size={demoSize}>
                    SALE
                  </TagLabel>
                  <TagLabel variant="subtle" size={demoSize}>
                    LIMITED
                  </TagLabel>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  <TagLabel variant="solid" rounded size={demoSize}>
                    FEATURED
                  </TagLabel>
                  <TagLabel variant="outline" rounded size={demoSize}>
                    TRENDING
                  </TagLabel>
                  <TagLabel variant="subtle" rounded size={demoSize}>
                    POPULAR
                  </TagLabel>
                </div>
              </div>
      ...
      >
        <div className="p-8">
          ...
          <nav className="space-y-2">
            {["ITEM", "LOOK", "NEWS", "ABOUT", "STOCKIST", "CONTACT"].map(
              (label) => (
                <Button
                  key={label}
                  variant="ghost"
