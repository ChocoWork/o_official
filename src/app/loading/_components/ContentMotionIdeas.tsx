...
const patterns = [
  {
    ...
    render: (
      <div className="flex flex-col items-center">
        ...
        <div className="w-px h-13.75 bg-black origin-top animate-[threadDraw_3s_ease-in-out_infinite]" />
      </div>
    ),
...
@keyframes threadDraw {
  ...
  },
  {
    ...
    render: (
      <div className="w-36 h-22.25 bg-linear-to-br from-[#e8e6e2] to-[#c9c4bc] animate-[imageWipe_3s_ease-in-out_infinite]" />
    ),
...
@keyframes imageWipe {
  ...
  <div className="overflow-hidden">
    <img src="..." className="transition-transform duration-1200 ease-out group-hover:scale-[1.06]" />
  </div>
  <p>ITEM NAME</p>
</div>`,
  },
  {
    ...
    render: (
      ...
      >
        DISCOVER
        <span className="absolute left-0 -bottom-0.75 h-px w-full origin-left scale-x-0 bg-black transition-transform duration-500 group-hover:scale-x-100" />
      </span>
    ),
    code: `<span className="group relative cursor-pointer tracking-widest transition-all duration-500 hover:tracking-[0.25em]">
  DISCOVER
  <span className="absolute left-0 -bottom-0.75 h-px w-full origin-left scale-x-0 bg-black transition-transform duration-500 group-hover:scale-x-100" />
</span>`,
  },
  {
    ...
    code: `<button className="group relative overflow-hidden border border-black px-5.25 py-2">
  <span className="absolute inset-0 -translate-x-full bg-black transition-transform duration-500 ease-out group-hover:translate-x-0" />
  ...
  },
  {
    ...
    render: (
      <div className="w-36">
        <div className="relative h-22.25 overflow-hidden bg-black/5">
          <span className="absolute inset-y-0 w-1/2 -skew-x-12 bg-linear-to-r from-transparent via-white/60 to-transparent animate-[sheen_1.8s_linear_infinite]" />
        </div>
        <div className="relative mt-2 h-2 w-3/4 overflow-hidden bg-black/5">
          <span className="absolute inset-y-0 w-1/2 -skew-x-12 bg-linear-to-r from-transparent via-white/60 to-transparent animate-[sheen_1.8s_linear_infinite]" />
        </div>
        <div className="relative mt-1.25 h-2 w-1/2 overflow-hidden bg-black/5">
          <span className="absolute inset-y-0 w-1/2 -skew-x-12 bg-linear-to-r from-transparent via-white/60 to-transparent animate-[sheen_1.8s_linear_infinite]" />
        </div>
      </div>
    ),
    code: `<div className="relative h-22.25 overflow-hidden bg-black/5">
  <span className="absolute inset-y-0 w-1/2 -skew-x-12 bg-linear-to-r from-transparent via-white/60 to-transparent animate-[sheen_1.8s_linear_infinite]" />
</div>
...
@keyframes sheen {
  ...
  },
  {
    ...
    render: (
      <div className="w-full overflow-hidden border-y border-black/10 py-2">
    ...
    code: `<div className="overflow-hidden border-y border-black/10 py-2">
  <div className="flex whitespace-nowrap animate-[hScroll_18s_linear_infinite]">
    {[0, 1, 2].map((i) => (
      <span key={i} className="mx-8.5 tracking-[0.3em] text-black/40">
        Le Fil des Heures
      </span>
    ))}
  </div>
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5.25">
      {patterns.map((p) => (
        ...
        >
          <div className="flex items-center justify-center h-40 px-5.25">
            {p.render}
          </div>
