      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        ...
        <div className="space-y-12">
          <section>
            ...
            <p
              className="text-base text-[#474747] leading-relaxed"
            >
          ...
          <section>
            ...
            <p
              className="text-base text-[#474747] leading-relaxed mb-4"
            >
            ...
            <ul
              className="list-disc list-inside space-y-2 text-base text-[#474747] mt-4"
            >
              <li>虚偽の情報を登録した場合</li>
          ...
          <section>
            ...
            <ul
              className="list-disc list-inside space-y-2 text-base text-[#474747]"
            >
              <li>クレジットカード決済</li>
              <li>銀行振込</li>
              <li>代金引換</li>
