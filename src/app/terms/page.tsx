  ...
  return (
    <div className="w-full max-w-4xl mx-auto pb-[34px] sm:pb-[42px] md:pb-[55px] lg:pb-[89px]">
      ...
      <div className="space-y-8">
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>利用規約</h5>
          <p
        ...
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>第1条（適用）</h5>
        ...
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>第2条（会員登録）</h5>
        ...
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>第3条（商品の注文と契約の成立）</h5>
          <p className="text-[#474747]" style={bodyTextStyle}>
        ...
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>第4条（支払方法）</h5>
        ...
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>第5条（商品の配送）</h5>
          <p className="text-[#474747]" style={bodyTextStyle}>
        ...
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>第6条（返品・交換）</h5>
          <p className="text-[#474747]" style={bodyTextStyle}>
        ...
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>第7条（禁止事項）</h5>
        ...
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>第8条（免責事項）</h5>
          <p className="text-[#474747]" style={bodyTextStyle}>
        ...
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>第9条（規約の変更）</h5>
          <p className="text-[#474747]" style={bodyTextStyle}>
        ...
        <section>
          <h5 className="mb-4 font-brand" style={sectionTitleStyle}>第10条（準拠法・裁判管轄）</h5>
          <p className="text-[#474747]" style={bodyTextStyle}>
