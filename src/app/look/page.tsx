            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    ...
                    <div className="group">
                        <div className="aspect-[2/3] bg-[#f5f5f5] mb-6 overflow-hidden">
                            <img
                                src="https://readdy.ai/api/search-image?query=Elegant%20minimalist%20fashion%20photography%20with%20model%20wearing%20flowing%20silk%20shirt%20in%20sand%20beige%20color%20paired%20with%20soft%20cardigan%20against%20clean%20white%20background%20with%20soft%20shadows%20highlighting%20fabric%20texture%20and%20refined%20aesthetic&width=800&height=1200&seq=look003&orientation=portrait"
                                alt="2024 SPRING/SUMMER"
                                className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                            />
                        </div>
                    ...
                    <div className="group">
                        <div className="aspect-[2/3] bg-[#f5f5f5] mb-6 overflow-hidden">
                            <img
                                src="https://readdy.ai/api/search-image?query=Sophisticated%20autumn%20fashion%20editorial%20showing%20model%20in%20elegant%20black%20wool%20coat%20over%20neutral%20dress%20with%20minimalist%20styling%20in%20soft%20natural%20light%20against%20simple%20architectural%20setting%20emphasizing%20timeless%20design&width=800&height=1200&seq=look004&orientation=portrait"
                                alt="2024 AUTUMN/WINTER"
                                className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                            />
                        </div>
                        <div className="space-y-3">
                    ...
                    <div className="group">
                        <div className="aspect-[2/3] bg-[#f5f5f5] mb-6 overflow-hidden">
                            <img
                                src="https://readdy.ai/api/search-image?query=Refined%20fashion%20editorial%20image%20with%20model%20wearing%20structured%20black%20blazer%20over%20silk%20shirt%20in%20minimalist%20setting%20with%20natural%20lighting%20emphasizing%20sharp%20tailoring%20and%20elegant%20proportions%20in%20contemporary%20style&width=800&height=1200&seq=look006&orientation=portrait"
                                alt="2024 AUTUMN/WINTER"
                                className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                            />
                        </div>
