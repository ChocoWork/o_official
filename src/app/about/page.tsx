  ...
  const principles = [
    {
      ...
      en: "TIMELESS / UNISEX",
      ja: "タイムレス・ユニセックス",
      text: "どの時代でも手に取りたくなる服を。シーズンごとにルックは発表しますが、一度世に出した服はつくり続け、いつでも手に取れるようにしています。性別の境界も設けず、男女を問わず着られるデザインに。時代も性別も越えて、長く誰かの日常であり続けますように。",
    },
    {
      no: "02",
      en: "NATURAL FIBERS",
    ...
    },
    {
      ...
      ja: "国内受注生産",
      text: "すべて、国内で受注生産。必要な人に、必要な分だけつくるため、廃棄はほとんど生まれません。安さを求めて海外でつくる時代でも、私たちは国内にこだわります。手を動かす職人がいなくなれば、その技術は二度と戻らない。国内でつくり続けることが、日本の縫製技術を未来へつなぐ唯一の方法だと考えています。",
    },
  ];
