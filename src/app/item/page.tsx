      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
          <div className="flex flex-wrap gap-3">
            <button className="px-6 py-2 text-xs tracking-widest transition-all duration-300 cursor-pointer whitespace-nowrap bg-black text-white font-brand">ALL</button>
            <button className="px-6 py-2 text-xs tracking-widest transition-all duration-300 cursor-pointer whitespace-nowrap border border-black text-black hover:bg-black hover:text-white font-brand">TOPS</button>
            <button className="px-6 py-2 text-xs tracking-widest transition-all duration-300 cursor-pointer whitespace-nowrap border border-black text-black hover:bg-black hover:text-white font-brand">BOTTOMS</button>
            <button className="px-6 py-2 text-xs tracking-widest transition-all duration-300 cursor-pointer whitespace-nowrap border border-black text-black hover:bg-black hover:text-white font-brand">OUTERWEAR</button>
            <button className="px-6 py-2 text-xs tracking-widest transition-all duration-300 cursor-pointer whitespace-nowrap border border-black text-black hover:bg-black hover:text-white font-brand">ACCESSORIES</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <Link href="/item/1">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                ...
                <h3 className="text-base text-black tracking-tight font-brand">Minimal Cotton Shirt</h3>
          ...
          <Link href="/item/2">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-black font-brand">¥22,000</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/item/3">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                <p className="text-xs text-[#474747] tracking-widest font-brand">TOPS</p>
                <h3 className="text-base text-black tracking-tight font-brand">Cashmere Knit</h3>
          ...
          <Link href="/item/4">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                ...
                <h3 className="text-base text-black tracking-tight font-brand">Wool Coat</h3>
          ...
          <Link href="/item/5">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                <p className="text-xs text-[#474747] tracking-widest font-brand">ACCESSORIES</p>
                <h3 className="text-base text-black tracking-tight font-brand">Leather Tote Bag</h3>
          ...
          <Link href="/item/6">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                <p className="text-xs text-[#474747] tracking-widest font-brand">TOPS</p>
                <h3 className="text-base text-black tracking-tight font-brand">Silk Blouse</h3>
          ...
          <Link href="/item/7">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                <p className="text-xs text-[#474747] tracking-widest font-brand">OUTERWEAR</p>
                <h3 className="text-base text-black tracking-tight font-brand">Tailored Blazer</h3>
                <p className="text-sm text-black font-brand">¥42,000</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/item/8">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                <p className="text-xs text-[#474747] tracking-widest font-brand">BOTTOMS</p>
                <h3 className="text-base text-black tracking-tight font-brand">Linen Pants</h3>
                <p className="text-sm text-black font-brand">¥19,000</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/item/9">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                <p className="text-xs text-[#474747] tracking-widest font-brand">ACCESSORIES</p>
                <h3 className="text-base text-black tracking-tight font-brand">Merino Wool Scarf</h3>
                <p className="text-sm text-black font-brand">¥12,000</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/item/10">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                <p className="text-xs text-[#474747] tracking-widest font-brand">TOPS</p>
                <h3 className="text-base text-black tracking-tight font-brand">Oversized Cardigan</h3>
          ...
          <Link href="/item/11">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                <p className="text-xs text-[#474747] tracking-widest font-brand">BOTTOMS</p>
                <h3 className="text-base text-black tracking-tight font-brand">Pleated Skirt</h3>
                <p className="text-sm text-black font-brand">¥21,000</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/item/12">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-2">
                <p className="text-xs text-[#474747] tracking-widest font-brand">ACCESSORIES</p>
                <h3 className="text-base text-black tracking-tight font-brand">Leather Belt</h3>
                <p className="text-sm text-black font-brand">¥8,000</p>
              </div>
            </div>
          </Link>
        </div>
