          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            {item.colors &&
              ...
              item.colors.length > 0 && (
                <div>
                  <p className="mb-2" style={optionTitleStyle}>
                    COLOR
                  </p>
                  <div className="flex gap-3 flex-wrap">
                    {(
                      ...
                      <Button
                        ...
                        variant={
                          color === colorOption.name ? "primary" : "secondary"
                        }
                        size="xs"
            ...
            {item.product_details && (
              <div className="border-t border-black/10 py-4 lg:py-6">
                <p className="mb-4 font-brand" style={optionTitleStyle}>
                  PRODUCT DETAILS
                </p>
                {typeof item.product_details === "string" ? (
                  <p
                    className="text-[#474747] whitespace-pre-line"
                    style={bodyTextStyle}
                  >
                    {item.product_details}
                  </p>
