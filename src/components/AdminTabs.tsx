export type TabType = 'KPI' | 'ACCOUNTING' | 'NEWS' | 'ITEM' | 'LOOK' | 'STOCKIST' | 'USER' | 'ORDER' | 'CONTACT';
...
const allTabs: TabType[] = ['KPI', 'ACCOUNTING', 'NEWS', 'ITEM', 'LOOK', 'STOCKIST', 'USER', 'ORDER', 'CONTACT'];
