...
const Header = () => {
  ...
  const drawerAccordionItems = drawerFilterSections.map((section) => ({
    key: section.key,
    title: <span className="header-drawer-accordion-title">{section.label}</span>,
    content: (
      ...
      >
        <div className="header-drawer-shell">
          <div className="header-drawer-top-row">
            <Link
              href="/"
              aria-label="Le Fil des Heures home"
              onClick={() => setDrawerOpen(false)}
            >
          ...
          <div className="header-drawer-content">
            ...
            <div className="header-drawer-follow">
              <p className="header-drawer-follow-title">
                FOLLOW US
              </p>
                ...
                {['instagram','facebook','twitter'].map((icon) => (
                  ...
                  >
                    <div className="w-5 h-5 flex items-center justify-center">
                      <i className={`ri-${icon}-line header-drawer-follow-icon`}></i>
                    </div>
                  </Button>
                ))}
              </div>
