---
name: create-agent
description: Create new agents, modify and improve existing agents, and measure agent performance. Use when users want to create an agent from scratch, edit, or optimize an existing agent, run evals to test an agent, benchmark agent performance with variance analysis, or optimize an agent's description for better triggering accuracy.
---
