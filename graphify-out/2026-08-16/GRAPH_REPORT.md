...
## Corpus Check
- 1630 files · ~1,077,211 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10298 nodes · 14668 edges · 1062 communities (771 shown, 291 thin omitted)
...
## Communities (1062 total, 291 thin omitted)
...
Cohesion: 0.04
Nodes (67): GET(), AUDIT_LOGS_SAFE_COLUMNS, GET(), CONTACT_STATUSES, CONTACT_TYPES, GET(), sanitizeSearchTerm(), DELETE() (+59 more)
...
Cohesion: 0.03
Nodes (85): Cache-Control header policy gap, CONTACT_TO_EMAIL recipient fallback misconfiguration, Cross-Origin-Opener-Policy / Cross-Origin-Resource-Policy, Data minimization principle, Fail-open login success (session/cookie failure swallowed, 200 returned), Fail-open rawUrl fallback on signing failure, src/app/api/admin/looks/[id]/route.ts, src/app/api/admin/looks/route.ts (+77 more)
...
### Community 14 - "createServiceRoleClient"
Cohesion: 0.05
Nodes (47): applyCsrfProtection(), POST(), confirmedResponse(), PayoutRow, POST(), requestSchema, CsrfDenyResponse, CsrfRotateResult (+39 more)
...
Cohesion: 0.05
Nodes (52): allowedImageTypes, DELETE(), GET(), getRequestUserAgent(), logNewsAudit(), PATCH(), patchStatusSchema, PUT() (+44 more)
...
Cohesion: 0.07
Nodes (64): 管理者 RBAC 権限チェック (authorizeAdminPermission), src/app/api/items/[id]/route.ts, src/app/api/items/route.ts, src/app/api/news/route.ts, Cache-Control: private, no-store, PublicItemGrid（catalog variant）, SectionTitle（home variant 専用）, item 一覧 セキュリティレビュー (+56 more)
...
Cohesion: 0.07
Nodes (35): GET(), PATCH(), updateStatusSchema, GET(), orderIdSchema, POST(), updateStatusSchema, formatCurrency() (+27 more)
...
Cohesion: 0.12
Nodes (24): src/app/admin/create-user/page.tsx, src/app/api/auth/identify/route.ts, src/app/api/auth/login/route.ts, src/app/api/auth/logout/route.ts, src/features/auth/ratelimit/index.ts, src/features/auth/middleware/rateLimit.ts, clientFetch, CSRF enforcement breaks the admin create-user UI (+16 more)

### Community 26 - "api/items/route.ts"
Cohesion: 0.11
...
Cohesion: 0.04
Nodes (48): ALLOWED_OTP_TYPES, buildRedirectResponse(), classifyConfirmError(), GET(), OtpType, POST(), tryVerifyOtpWithTypes(), DELETE() (+40 more)
...
Cohesion: 0.04
Nodes (63): getLatestNews(), NewsArticle, GET(), allowedImageTypes, colorSchema, createItemSchema, GET(), itemCategorySchema (+55 more)
