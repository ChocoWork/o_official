# Graph Report - o_official  (2026-08-11)

## Corpus Check
- 1570 files · ~1,046,649 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9846 nodes · 14034 edges · 1012 communities (731 shown, 281 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 249 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af11bbf0`
...
1. `createServiceRoleClient()` - 170 edges
2. `logAudit()` - 107 edges
3. `authorizeAdminPermission()` - 102 edges
4. `createClient()` - 90 edges
5. `ComponentSize` - 86 edges
6. `CostProfitSection()` - 60 edges
...
## Communities (1012 total, 281 thin omitted)
...
Cohesion: 0.03
Nodes (71): ACCOUNT_TYPE_LABELS, AXIS_FORMAT, BalanceBars(), BUSINESS_TYPE_OPTIONS, CashTrendChart(), COMPARISON_COLUMN_LABELS, COMPARISON_TABS, ComparisonBasis (+63 more)

### Community 4 - "Code Review: look/[id]"
Cohesion: 0.09
...
### Community 6 - "authorizeAdminPermission"
Cohesion: 0.04
Nodes (84): AUDIT_LOGS_SAFE_COLUMNS, GET(), CONTACT_STATUSES, CONTACT_TYPES, GET(), sanitizeSearchTerm(), DELETE(), colorPresetSchema (+76 more)
...
### Community 9 - "PublicItemGrid.tsx"
Cohesion: 0.04
...
### Community 12 - "resolveRequestUser"
Cohesion: 0.06
Nodes (46): buildResponse(), GET(), isUserRole(), UserRole, EnrollRequestSchema, isUserRole(), POST(), toQrImageSrc() (+38 more)
...
### Community 14 - "implement-uiux レビュー基準スキル"
Cohesion: 0.10
...
Cohesion: 0.07
Nodes (35): POST(), replySchema, GET(), PATCH(), updateStatusSchema, collectRecipients(), extractEmail(), isTimestampFresh() (+27 more)

### Community 22 - "cost-profit/route.ts"
Cohesion: 0.06
Nodes (40): BusinessType, businessTypeSchema, closingAdjustmentSchema, closingBalancesSchema, CumulativeEntryRow, EMPTY_CLOSING, EMPTY_PLAN, emptyFinanceResponse() (+32 more)

### Community 23 - "src/proxy.ts (Next.js 16 proxy / 旧 middleware)"
Cohesion: 0.10
...
### Community 27 - "TaxCalendarView.tsx"
Cohesion: 0.11
...
### Community 37 - "logAudit"
Cohesion: 0.04
Nodes (51): DELETE(), PUT(), updateTemplateSchema, createTemplateSchema, GET(), POST(), bodySchema, POST() (+43 more)

### Community 38 - "account/page.tsx"
Cohesion: 0.06
Nodes (35): AccountOrderDetailPage(), acuminFont, acuminLgStyle, bodyStyle, labelStyle, lgStyle, OrderDetail, accountGateTitleStyle (+27 more)

### Community 39 - "PublicLookGrid.tsx"
Cohesion: 0.07
Nodes (42): generateMetadata(), LookDetailPage(), Props, LookPage(), LookPageSearchParams, Home(), LookImageGallery(), LookImageGalleryProps (+34 more)

### Community 40 - "ドハティのしきい値（応答フィードバック）"
Cohesion: 0.15
...
### Community 44 - "clientFetch"
Cohesion: 0.04
Nodes (63): EditNewsPage(), NewsArticle, getDefaultFormValues(), getTodayDateString(), NEWS_CATEGORY_OPTIONS, NewsForm(), NewsFormProps, AdminStockistEditPage() (+55 more)

### Community 45 - "Button.tsx"
Cohesion: 0.05
Nodes (36): headingTextStyle, Window, CartItemRow(), CartItemRowProps, OrderSummary(), OrderSummaryProps, CartEntry, useCartItems() (+28 more)
...
### Community 47 - "DB ACL（roles / permissions / role_permissions / user_roles）"
Cohesion: 0.33
...
### Community 57 - "A04 Insecure Design"
Cohesion: 0.17
...
Cohesion: 0.15
Nodes (22): BusinessType, buildDepreciationEntries(), buildGeneralLedger(), buildJournal(), buildTrialBalance(), JournalLine, LedgerRow, sideSign() (+14 more)
...
### Community 74 - "ConfirmDialog（新規・フォーカストラップ対応）"
Cohesion: 0.40
...
### Community 80 - "lib/supabase/server.ts"
Cohesion: 0.11
Nodes (14): addWishlistItemSchema, GET(), getClientIp(), POST(), accessCookieName, AuthUserResponse, createPublicClient(), extractAccessTokenFromCookie() (+6 more)
...
### Community 100 - "src/lib/storage/news-images.ts"
Cohesion: 0.04
...
Cohesion: 0.15
Nodes (13): applyCsrfProtection(), attachRotatedCsrf(), isRotatedCsrf(), missingMigrationResponse(), POST(), createProfileQueryBuilder(), ADMIN, authorizeMock (+5 more)

### Community 107 - "shipping-carriers.ts"
Cohesion: 0.53
Nodes (4): isShippingCarrierId(), SHIPPING_CARRIER_IDS, SHIPPING_CARRIERS, ShippingCarrierId
...
Cohesion: 0.08
Nodes (26): StockistPage(), Checkbox(), CheckboxProps, UICheckboxCheckStyle, UICheckboxShape, SectionTitle(), SectionTitleProps, ALL_PREFECTURES (+18 more)
...
### Community 130 - "cookie.ts"
Cohesion: 0.05
Nodes (62): POST(), POST(), buildRedirectResponse(), GET(), POST(), buildSessionResponse(), GET(), Email (+54 more)

### Community 131 - "statements.ts"
Cohesion: 0.15
...
### Community 151 - "checkout-draft.service.ts"
Cohesion: 0.16
...
Cohesion: 0.11
Nodes (21): accountOptionsFor(), Account, ACCOUNTS, AccountScope, AccountSide, AccountType, BY_CODE, BY_NAME (+13 more)
...
### Community 272 - "postal-code.service.ts"
Cohesion: 0.14
...
### Community 285 - "admin/page.tsx"
Cohesion: 0.08
Nodes (26): AdminPage(), AdminPageContent(), allAdminTabs, escapeCsvValue(), ForbiddenErrorBody, formatOrderItems(), ORDER_CSV_HEADERS, ORDER_STATUS_FILTERS (+18 more)
...
### Community 648 - "N-4 image_url を持つ記事のみ sm+ でサムネイル表示"
Cohesion: 0.40
...
### Community 779 - "update-shipping/route.ts"
Cohesion: 0.20
...
### Community 903 - "SectionTitle（home variant 専用）"
Cohesion: 0.83
...
### Community 1023 - "PublicNewsGrid.tsx"
Cohesion: 0.06
Nodes (42): getLatestNews(), NewsArticle, GET(), buildDescription(), generateMetadata(), NewsDetailPage(), NewsDetailPageProps, resolveCategory() (+34 more)
...
## Knowledge Gaps
- **4677 isolated node(s):** `ShippingCarrierId`, `Global Constraints`, `File Structure`, `Task 1: 注文確認メールにお届け先を追加し、実際に送る（FREQ-264）`, `Task 2: ゲスト注文を会員へ紐付ける共通関数（FREQ-265 前半）` (+4672 more)
